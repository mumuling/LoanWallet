...
package com.pingxun.daishangqianbao.callback;

import com.google.gson.stream.JsonReader;
import com.lzy.okgo.convert.Converter;
import com.pingxun.daishangqianbao.data.BaseBean;
import com.pingxun.daishangqianbao.data.SimpleResponse;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != BaseBean.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                response.close();
                //noinspection unchecked
                return (T) simpleResponse.toBase();
            } else {
...
//                }
                    ...
                    throw new IllegalStateException("错误代码：" + code + "，错误信息：" + baseBean.message);
                }
            }
        }
    }

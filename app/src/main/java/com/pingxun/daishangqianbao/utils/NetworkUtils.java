...
public class NetworkUtils {
    ...
    public static boolean isNetworkConnected(Context context) {
        Log.d("common", "isNetworkConnected() ");
        if (context != null) {
            ...
            Log.d("common", "isNetworkConnected(), mNetworkInfo: " + mNetworkInfo);
    ...
    public static String[] getNetType(Context paramContext) {
        ...
        ConnectivityManager localConnectivityManager = (ConnectivityManager) paramContext.getSystemService("connecti vity");

...
import com.pingxun.daishangqianbao.utils.StreamTool;
...
//        http.setRequestProperty("Content-Type", "application/json");
        ...
        if(ObjectHelper.isNotEmpty(InitDatas.JSESSIONID)){
            http.setRequestProperty("Cookie", InitDatas.JSESSIONID);
        }
    ...
    public static String getUnsafe(String requestUrl) {
        try {
...
//                        httpsURLConnection.setHostnameVerifier();
            ...
            httpsURLConnection.setRequestProperty("Cookie", InitDatas.JSESSIONID);
